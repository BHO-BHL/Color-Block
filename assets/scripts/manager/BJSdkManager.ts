/*
 * @Author: carolsail 
 * @Date: 2025-05-29 13:50:34 
 * @Last Modified by: carolsail
 * @Last Modified time: 2025-06-05 12:01:30
 */

import AudioManager from "./BJAudioManager";

export default class BJSdkManager {
    public static _instance: BJSdkManager = null

    public static get instance() {
        if (null == this._instance) {
            this._instance = new BJSdkManager();
        }
        return this._instance
    }

    shareTitle: string = '好玩上头的游戏，快来挑战吧？'
    shareImg: string = ''
    // 激励视频
    videoId: string = 'adunit-bdeaa2444c21708d6'
    private videoAd = null
    // 插屏
    interstitialId: string = 'adunit-fdctdd1a793618db1'
    private interstitialAd = null
    // 横幅
    bannerId: string = 'adunit-c78a1666971d2b80'
    private bannerAd = null
    // 原生格子: 横向（后台90%显示）
    customRowId: string = 'adunit-3fecc12758fa3a7b'
    private customRowAd = null
    // 原生格子: 纵向（后台80%显示）
    customColId: string = 'adunit-343ddc113cec6a84a'
